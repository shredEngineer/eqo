...
**Established:** M-EHD Electrohydrodynamics/ion wind · M-KOR Corona/gas discharge · M-MSN Superconductivity (Meissner, flux pinning) · M-DIA Diamagnetic levitation · M-ACL Acoustic levitation · M-AER Aerodynamics/convection · M-TEL Thermoelectrics · M-PIE Piezo-/electrostriction · M-TRB Triboelectrics · M-IND Induction/eddy currents · M-MST Magnetostriction · M-JOU Joule/induction heating · M-CHX Exothermic chemistry · M-ELY Electrolysis · M-KAV Cavitation & sonoluminescence · M-TLM Tribo-/electroluminescence · M-RAD Radiometric forces (thermal transpiration) · M-LFR Leidenfrost · M-CAS Casimir *(real effect; extraction claims → M-ZPE)* · M-RES Mechanical resonance/structure-borne sound · M-MCH Classical mechanics (statics/dynamics) *(instance: ex:leonardo-refutation-1494)* · M-REL Relativistic kinematics (special/general relativity) *(instance: ex:sagnac-1913)* · M-SRF Guided surface-wave propagation (single-conductor / Sommerfeld-Goubau) *(rationale: a transverse-magnetic surface wave bound to a single unshielded conductor, carrying a genuine longitudinal electric-field component with displacement current as its return path — Sommerfeld and Zenneck 1907, Stratton 1941, Goubau 1950. Added because single-conductor and "longitudinal transmission" claims recur across the record and had no established node to attach to, which forced them to grade off heterodox edges and systematically understated their theory embedding. Instance: ex:avramenko-single-wire-1993)*

**Established artifact classes** *(conventional explanatory offers; central for this corpus):*
M-ART-PWR Power-measurement error (non-sinusoidal signals, power factor, RMS confusion) · M-ART-CAL Calorimetry/sensor placement · M-ART-TOL Instrument tolerance/uncalibrated transducer *(rationale: a transducer read outside a per-device calibration, or outside the temperature, supply and mounting conditions its own vendor documentation specifies. The magnitudes are neither small nor disputed: an untrimmed linear Hall sensor is specified across a roughly ±35 % part-to-part sensitivity band, permanent-magnet bias drifts −0.01 to −0.2 %/°C by material, common timer-driven excitation carries a 3–10 % frequency tolerance, and a negative-conductance transport device oscillates at radio frequency by design when biased into its useful region. Added because errors of that size are conventional, vendor-documented, and sufficient on their own to account for a reported magnitude — yet had no established node, leaving them absorbed into M-ART-CAL, which covers where a sensor sits rather than whether it was calibrated.)* · M-ART-STA Electrostatic force on balance/rig · M-ART-THK Thermal convection/draft *(instance: Einstein's account of the Reich ΔT, 1941)* · M-ART-VIB Vibration/footfall · M-ART-CAM Image/camera artifact, editing, staging · M-ART-AUF Suspension/threads/hidden drive *(instance: Keely findings 1899)* · M-ART-KON Sample contamination · M-ART-PER Perceptual/optical illusion *(instance: mystery-spot geometries)* · M-ART-STT Statistics/selection effects *(instance: Maddox analysis of the Benveniste counts)* · M-ART-SUG Suggestion/expectancy — placebo, demand characteristics *(instance: ex:franklin-commission-1784)* · M-ART-IDE Ideomotor movement *(instance: ex:enright-reanalysis)* · M-ART-FAB Fabricated report — print/media hoax as documented finding *(instance: ex:kowsky-frost-1927)*
